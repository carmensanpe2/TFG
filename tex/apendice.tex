...
Las soluciones de esta ecuación tienen forma de onda plana y $\Psi$ se representa como un autovector de 4 componentes pero que puede expresarse en términos de dos autovectores de espín, conocidos como \textit{espinores de Dirac} \cite{MCR}. 
\begin{align}
\begingroup 
\renewcommand*{\arraystretch}{0.8}
\setlength\arraycolsep{10pt}
